...
(() => {
  ...
  const slides = [
    { src: 'media/hero-01.jpg', label: 'TESLA MODEL Y', mobilePosition: '92% 53%' },
    { src: 'media/hero-02.jpg', label: 'FORD F-150', mobilePosition: '92% 53%' },
    { src: 'media/hero-03.jpg', label: 'GMC DENALI HD', mobilePosition: '92% 53%' },
    { src: 'media/hero-04.jpg', label: 'CADILLAC ESCALADE', mobilePosition: '92% 53%' },
    { src: 'media/hero-05.jpg', label: 'TESLA MODEL Y', mobilePosition: '92% 53%' }
  ];
  ...
  style.textContent = `
    ...
    .em-hero-slide{position:absolute;inset:0;background-size:auto 72%;background-position:88% center;background-repeat:no-repeat;opacity:0;transition:opacity .8s ease;filter:contrast(1.05) saturate(1.04)}
    .em-hero-slide.active{opacity:1}
    .hero-overlay{z-index:1!important;background:linear-gradient(90deg,rgba(0,0,0,.96) 0%,rgba(0,0,0,.84) 28%,rgba(0,0,0,.44) 48%,rgba(0,0,0,.10) 64%,transparent 78%)!important}
    ...
    @media (max-width:620px){
      ...
      .hero{height:760px!important;min-height:760px!important;padding:70px 22px 106px!important;align-items:flex-start!important}
      .hero-content{width:53%!important;max-width:230px!important;padding:0!important;z-index:3!important}
      .hero .kicker{font-size:8px!important;line-height:1.35!important;letter-spacing:.22em!important;white-space:normal!important;margin:0 0 22px!important;color:#ff3a42!important;max-width:220px!important}
      .hero h1{font-size:38px!important;line-height:.98!important;letter-spacing:-.045em!important;margin:0 0 22px!important;max-width:220px!important;font-weight:850!important}
      .hero h1 span{color:#c6c6c6!important}
      .hero-copy{font-size:12px!important;line-height:1.48!important;max-width:215px!important;color:#ededed!important;margin:0!important}
      .hero-actions{display:flex!important;align-items:flex-start!important;flex-direction:column!important;gap:14px!important;margin-top:22px!important}
      .hero-actions .btn{height:50px!important;min-height:50px!important;padding:0 17px!important;font-size:12px!important;border-radius:4px!important;box-shadow:none!important;white-space:nowrap!important}
      .hero-actions .btn::after{content:'→';margin-left:9px;font-size:17px;font-weight:400}
      ...
      .em-hero-slide{background-size:auto 48%!important;background-position:var(--mobile-position)!important;background-color:#050505!important;filter:contrast(1.08) saturate(1.06)}
      .hero-overlay{background:linear-gradient(90deg,rgba(0,0,0,.98) 0%,rgba(0,0,0,.89) 26%,rgba(0,0,0,.58) 43%,rgba(0,0,0,.18) 57%,rgba(0,0,0,.02) 69%,transparent 82%)!important}
    ...
    @media (max-width:430px){
      ...
      .hero{height:705px!important;min-height:705px!important;padding:50px 18px 96px!important}
      .hero-content{width:54%!important;max-width:205px!important}
      .hero .kicker{font-size:7px!important;margin-bottom:19px!important;letter-spacing:.21em!important;max-width:200px!important}
      .hero h1{font-size:34px!important;margin-bottom:19px!important;max-width:200px!important;line-height:.98!important}
      .hero-copy{font-size:10.5px!important;line-height:1.45!important;max-width:195px!important}
      .hero-actions{margin-top:19px!important}
      .hero-actions .btn{height:46px!important;min-height:46px!important;padding:0 14px!important;font-size:10.5px!important}
      .hero-actions .text-link{font-size:10px!important}
      .em-hero-slide{background-size:auto 45%!important;background-position:94% 52%!important}
